	...
	block.transactions.forEach(function(transaction) {
      ...
      if (myblock == true) {  //This block is written by my waves node
		...
		if (block.height >= 1740000) { 
			...
			if ( block.reward > 200000000 && block.reward < 600000000 ) {
				myreward = block.reward - (( block.reward - wavesdao ) / 2 )*2
			} else if ( block.reward >= 600000000 ) {
				myreward = block.reward - wavesdao - xtn
			} else {
				myreward = block.reward
			}
